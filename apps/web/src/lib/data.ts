...
const adminSelectFields = {
    ...
    capture_year: images.capture_year,
...
const {
    ...
    capture_year: _omitCaptureYearAdminList,
...
const {
    ...
    capture_year: _omitCaptureYearMap,
