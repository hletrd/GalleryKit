                            ...
                            {files.map((file, i) => {
                                ...
                                <Card key={i} className="relative group border bg-muted/30">
                                    <Button
                                        variant="ghost"
                                        size="icon"
                                        className="absolute top-1 right-1 h-6 w-6 z-10 bg-background/50 hover:bg-destructive hover:text-white rounded-full opacity-0 group-hover:opacity-100 transition-opacity"
