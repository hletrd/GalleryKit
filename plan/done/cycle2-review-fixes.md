...
- [x] Re-run full repo gates after the fixes.
...
## Completion note
- Architect verification: APPROVED (current HEAD reviewed after the full gate rerun; no new architectural regressions found).
