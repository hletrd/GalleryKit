# Cycle 43/100 Deferred Findings

No new Cycle 43 findings are deferred. All new Cycle 43 findings are scheduled in `.context/plans/cycle-43-2026-07-01-plan.md`.
...
- `TV-40-03` - JS operational scripts need semantic checking. Exit criterion: migrate the operational script check to semantic `checkJs` or equivalent without masking existing script type errors.
