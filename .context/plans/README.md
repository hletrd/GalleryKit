...
- Run-10 Cycle 18/100 Implementation Plan - active ledger from Cycle 18 aggregate at HEAD `a1863405`: release/carry-forward ledger reconciliation, PAT usage telemetry semantics, behavior-test hardening, CLIP/pipeline docs/action contracts, mobile public filter hierarchy, README truthfulness, gates, push, and per-cycle deploy (`cycle-18-2026-07-08-plan.md`)
- Run-10 Cycle 18/100 Deferred Findings - active deferred register preserving severity/confidence and exit criteria for broad performance, test-infrastructure, admin redesign, live-host validation, and RTL future-scope items (`cycle-18-2026-07-08-deferred.md`)
