...
- 2026-04-18 final Ralph closeout also broadened DB-restore cache invalidation to the full app tree so restored topic/photo pages cannot remain stale behind long ISR windows.
