...
photo-viewer.tsx, lightbox.tsx, image-manager.tsx.

## New Findings

No new actionable performance findings. The codebase continues to use
...
- Cursor-based pagination for load-more with offset cap (10000)
